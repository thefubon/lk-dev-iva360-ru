...
function createInitialSteps(): TestStep[] {
  return [
    { id: 'tcp', label: 'Проверка доступности хоста...', status: 'pending' },
    { id: 'bind', label: 'Проверка Bind DN и пароля...', status: 'pending' },
    { id: 'search', label: 'Поиск пользователей по Base DN...', status: 'pending' },
  ]
}
